...
export const SetTimePassed = ({date})=>{
  ...
  useEffect(()=>{
    ...
    if(name.charAt(name.length-1)==="s"){
      setRetData(num +" "+ t(name.slice(0, name.length-1))+((currLangCode==="hi"||(currLangCode==="fr"&&name==="months"))?"":"s"))
    } else{
